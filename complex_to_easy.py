...
class ESRGAN:
    ...
    def _init_model(self):
        self.exec_provider = 'AzureExecutionProvider' # 'CPUExecutionProvider' 'DmlExecutionProvider'
...
using_model_path = 'RealESRGAN_x4plus_anime_6B.onnx'
input_path = sys.argv[1]
print('Init....')
model = ESRGAN(using_model_path, tile_size=512, scale=2)
